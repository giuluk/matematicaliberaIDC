...
\newcommand{\opfun}[9]{
  ...
  \disegno{
    ...
    \nodobin{(\xna, \yla)}{(\xnb, \yla)}{\xnr}{\ylb}{\op}{\ris}
...
%   \def \ndim{1.0}
  \disegno{
    \draw (0, 0) node{$\oa^\ob$};
    \nodobin{(\xna, \yla)}{(\xnb, -.1)}{\xnr}{\ylb}{\op}{\ris}
    \freccia{(\xna-1, 0)}{(\xna-.3, 0)}{left}{\loa}
...
%   \def \ndim{1.0}
  ...
  \disegno{
    ...
    \nodobin{(\xa, \la)}{(\xc, \la)}{\xb}{\lb}{+}{12}
    \nodobin{(\xb, \lb)}{(\xe, \la)}{\xd}{\lc}{\times}{24}
  }
}
...
\newcommand{\precedenzaalg}{
  ...
  \disegno{
    \draw (0, 0) node{$7 ~+~ 5 ~\times~ 2$};
    \nodobin{(\xc, \la)}{(\xe, \la)}{\xd}{\lb}{\times}{10}
    \nodobin{(\xa, \la)}{(\xd, \lb)}{\xb}{\lc}{+}{17}
  }
}
...
%     }
    \draw (0, 0) node{
    $49 ~-~ [2^4 ~\times~ (14 ~:~ 7) ~+~ 10]~=$};
    \nodobin{(\xc, \la)}{(\xe, 0)}{\xd}{\lb}{\uparrow}{\phantom{16}}
    \nodobin{(\xg, \la)}{(\xi, \la)}{\xh}{\lb}{:}{\phantom{2}}
    \parentesi{\xh}{\lb}{.8}{(}{)}
    \nodobin{(\xd, \lb)}{(\xh, \lb)}{\xf}{\lc}{\times}{\phantom{32}}
    \nodobin{(\xf, \lc)}{(\xk, \la)}{\xj}{\ld}{+}{\phantom{42}}
    \parentesi{\xj}{\ld}{1}{[}{]}
    \nodobin{(\xa, \la)}{(\xj, \ld)}{\xb}{\le}{-}{\phantom{7}}
    \draw (\xb, \le) 
...
%     }
    \draw (0, 0) node{
    $49 ~-~ [2^4 ~\times~ (14 ~:~ 7) ~+~ 10]~=$};
    \nodobin{(\xc, \la)}{(\xe, 0)}{\xd}{\lb}{\uparrow}{16}
    \nodobin{(\xg, \la)}{(\xi, \la)}{\xh}{\lb}{:}{2}
    \parentesi{\xh}{\lb}{.8}{(}{)}
    \nodobin{(\xd, \lb)}{(\xh, \lb)}{\xf}{\lc}{\times}{32}
    \nodobin{(\xf, \lc)}{(\xk, \la)}{\xj}{\ld}{+}{42}
    \parentesi{\xj}{\ld}{1}{[}{]}
    \nodobin{(\xa, \la)}{(\xj, \ld)}{\xb}{\le}{-}{7}
    \draw (\xb, \le) 
      node[draw, above, rectangle,rounded corners=1pt, very thick] 
          {$7$};
  }
...
%     }
    ...
    $8^9 ~\times~ 8^5 ~:~ (8^3)^4 ~:~ 
    [4^{12} ~:~ (4^2)^5] ~+~ 27^2 ~:~ 9^2 ~=$};
    \nodobin[\footnotesize]{(\xa, \la)}{(\xc, \la)}{\xb}{\lb}{p1}{8^{14}}
    \nodobin[\footnotesize]{(\xe, \la)}{(\xg, 0)}{\xf}{\lb}{p3}{8^{12}}
    \nodobin[\footnotesize]{(\xk, \la)}{(\xm, 0)}{\xl}{\lb}{p3}{4^{10}}
    \nodobin[\footnotesize]{(\xo, \la)}{(\xq, \la)}{\xp}{\lb}{p5}{3^{2}}
    \nodobin[\footnotesize]{(\xb, \lb)}{(\xf, \lb)}{\xd}{\lc}{p2}{8^{2}}
    \nodobin[\footnotesize]{(\xi, \la)}{(\xl, \lb)}{\xj}{\lc}{p2}{4^{2}}
    \nodobin{(\xp-.2, \lb+.2)}{(\xp+.2, \lb+.4)}{\xp}{\lc}{\uparrow}{9}
    \nodobin{(\xd-.2, \lc+.2)}{(\xd+.2, \lc+.4)}{\xd}{\ld}{\uparrow}{64}
    \nodobin{(\xj-.2, \lc+.2)}{(\xj+.2, \lc+.4)}{\xj}{\ld}{\uparrow}{16}
    \parentesi{\xj}{\ld}{1}{[}{]}
    \nodobin{(\xd, \ld)}{(\xj, \ld)}{\xh}{\le}{:}{4}
    \nodobin{(\xh, \le)}{(\xp, \lc)}{\xn}{\lf}{+}{13}
    \draw (\xn, \lf) 
...
%     }
    ...
    \nodobin{(\xa, \la)}{(\xc, 0)}{\xb}{\lb}{\uparrow}{27}
    \nodobin{(\xe, \la)}{(\xg, 0)}{\xf}{\lb}{\uparrow}{25}
    \nodobin[\footnotesize]{(\xl, \la)}{(\xp, \la)}{\xn}{\lb}{p5}{5^2}
    \nodobin{(\xn-.2, \lb+.2)}{(\xn+.2, \lb+.4)}{\xn}{\lc}{\uparrow}{25}
    \nodobin{(\xf, \lb)}{(\xi, \la)}{\xh}{\lc}{\times}{50}
    \nodobin{(\xh, \lc)}{(\xn, \lc)}{\xj}{\ld}{-}{25}
    \parentesi{\xj}{\ld}{1}{(}{)}
    \nodobin{(\xb, \lb)}{(\xj, \ld)}{\xd}{\le}{-}{2}
    \draw (\xd, \le) 
      node[draw, above, rectangle,rounded corners=1pt, very thick] 
          {$2$};
  }
...
%   \def \ndim{1.0}
  ...
  \def \xc{-5.45} \def \xd{-4.7} \def \xe{-3.7} 
  \def \xf{-2.85} \def \xg{-2.1} \def \xh{-1.35} 
  \def \xi{-0.1} \def \xj{+0.8} \def \xk{+1.5} 
  \def \xl{+1.85} \def \xm{+2.02} \def \xn{+3.1} 
  \def \xo{+3.9} \def \xp{+4.85} \def \xq{+5.6} 
%     \foreach \x/\l in {\xa/a, \xb/b, \xc/c, \xd/d, \xe/e, 
%                        \xf/f, \xg/g, \xh/h, \xi/i, \xj/j, 
%                        \xk/k, \xl/l, \xm/m, \xn/n, \xo/o, 
%                        \xp/p, \xq/q%, \xr/r, \xs/s, \xt/t,
...
%     }
    ...
    $[4 ~\times~ 5 ~+~ 16 ~:~ 2 ~-~ (13 ~-~ 2^{\dots}) ~\times~ 2] ~:~ 
      2 ~=~ 9$};
    \nodobin{(\xa, \la)}{(\xc, \la)}{\xb}{\lb}{\times}{20}
    \nodobin{(\xe, \la)}{(\xg, \la)}{\xf}{\lb}{:}{8}
    \nodobin{(\xk, \la)}{(\xm, 0)}{\xl}{\lb}{\uparrow}{\phantom{8}}
    \nodobin{(\xb, \lb)}{(\xf, \lb)}{\xd}{\lc}{+}{28}
    \nodobin{(\xi, \la)}{(\xl, \lb)}{\xj}{\lc}{-}{\phantom{5}}
    \parentesi{\xj}{\lc}{.8}{(}{)}
    \nodobin{(\xj, \lc)}{(\xo, \la)}{\xn}{\ld}{\times}{\phantom{10}}
    \nodobin{(\xd, \lc)}{(\xn, \ld)}{\xh}{\le}{-}{\phantom{18}}
    \parentesi{\xh}{\le}{1}{[}{]}
    \nodobin{(\xh, \le)}{(\xq, \la)}{\xp}{\lf}{:}{\phantom{9}}
    \draw (\xp, \lf) 
      node[draw, above, rectangle,rounded corners=1pt, very thick] 
          {$\textcolor{blue}{9}$};
}
...
%     }
    ...
    $(3^4)^3 ~\times~ 3^{\dots} : (3^3)^5 ~-~ 2^3 ~\times~ 2 
     ~\times~ (20 ~-~ 3 ~\times~ 5) ~=~ 1$};
    \nodobin[\footnotesize]{(\xa, \la)}{(\xc, 0)}{\xb}{\lb}{p3}{3^{12}}
    \nodobin[\footnotesize]{(\xg, \la)}{(\xi, 0)}{\xh}{\lb}{p3}{3^{15}}
    \nodobin[\footnotesize]{(\xk, \la)}{(\xm, \la)}{\xl}{\lb}{p2}{8^{2}}
    \nodobin{(\xq, \la)}{(\xs, \la)}{\xr}{\lb}{\times}{15}
    \nodobin[\footnotesize]{(\xb, \lb)}{(\xe, \la)}{\xd}{\lc}{p1}
      {\phantom{8^{14}}}
    \nodobin{(\xl-.2, \lb+.2)}{(\xl+.2, \lb+.4)}{\xl}{\lc}{\uparrow}{16}
    \nodobin{(\xo, \la)}{(\xr, \lb)}{\xp}{\lc}{-}{5}
    \parentesi{\xp}{\lc}{.8}{(}{)}
    \nodobin[\footnotesize]{(\xd, \lc)}{(\xh, \lb)}{\xf}{\ld}{p2}
      {\phantom{8^{14}}}
    \nodobin[\footnotesize]{(\xf-.2, \ld+.2)}{(\xf+.2, \ld+.4)}{\xf}{\le}
      {\uparrow}{~\textcolor{blue}{\bigstar}}
    \nodobin{(\xl, \lc)}{(\xp, \lc)}{\xn}{\ld}{\times}{80}
...
%     \nodobin{(\xc, \la)}{(\xe, \la)}{\xd}{\lb}{\times}{12}
%     \nodobin{(\xg, \la)}{(\xi, \la)}{\xh}{\lb}{-}{2}
%     \parentesi{\xh}{\lb}{.8}{(}{)}
%     \nodobin{(\xk, \la)}{(\xm, +0.0)}{\xl}{\lb}{\uparrow}{9}
%     \nodobin{(\xo, \la)}{(\xq, \la)}{\xp}{\lb}{\times}{15}
%     \nodobin{(\xs, \la)}{(\xu, +0.0)}{\xt}{\lb}{\uparrow}{25}
%     \nodobin{(\xw, \la)}{(\xy, +0.0)}{\xx}{\lb}{\uparrow}{8}
%     \nodobin{(\xh, \lb)}{(\xl, \lb)}{\xj}{\lc}{\times}{18}
%     \nodobin{(\xt, \lb)}{(\xx, \lb)}{\xv}{\lc}{+}{33}
%     \parentesi{\xv}{\lc}{1}{(}{)}
%     \nodobin{(\xj, \lc)}{(\xp, \lb)}{\xn}{\ld}{-}{3}
%     \parentesi{\xn}{\ld}{.8}{[}{]}
%     \nodobin{(\xv, \lc)}{(\xaa, \la)}{\xz}{\ld}{:}{11}
%     \nodobin{(\xd, \lb)}{(\xn, \ld)}{\xf}{\le}{:}{4}
%     \nodobin{(\xa, \la)}{(\xf, \le)}{\xb}{\lf}{+}{6}
%     \nodobin{(\xb, \lf)}{(\xz, \ld)}{\xr}{\lg}{+}{17}
%     \draw (\xr, \lg) 
%       node[draw, above, rectangle,rounded corners=1pt, very thick] 
%           {$\ris$};
%   }
