...
\affiancati{.49}{.49}{
\immagine[.8]{Testo alternativo figura: linea orizzontale che rappresenta 
il livello del mare a 0 m, sulla sinistra la rappresentazione del monte 
Everest (sopra la linea orizzontale) con indicata sulla cima l'altezza di 
+8855m e sulla destra la rappresentazione della fossa delle Marianne 
(sotto la linea orizzontale) con indicato il punto più profondo a -10916m.}
{\everest}
}{
...
\immagine[.8]
{Testo alternativo figura: retta orientata verso destra con in mezzo 
indicato il numero 0, su cui sono rappresentati numeri sempre più piccoli 
verso sinistra (-1, -2, -3, \dots) e sempre più grandi verso destra 
(+1, +2, +3, \dots); la distanza tra due numeri è sempre la stessa ed è 
rappresentata dall'unità di misura.}
{\intrappgeo}
...
\immagine[.9]
{Testo alternativo figura: in -7 il segno è meno e il valore assoluto è 7, 
...
\end{itemize}
\immagine[.8]{Testo alternativo figura: retta orientata verso destra con 
evidenziati i numeri dell'esempio e pertanto l'ordine rappresentato, 
dal numero più piccolo al più grande, è il seguente: -5, -3, -1 0, +4.}
{\rettaconfronto}
\end{esempio}
...
\immagine{Testo alternativo figura: addizione tra due numeri relativi, 
in particolare \((+2)+(+5)=+8\) con indicato il simbolo dell'operazione 
in mezzo ai due numeri e davanti ciascun numero il relativo segno.}
{\addizioneesegno}
}
...
% \vspace{-2.5em}
\immagine[.8]{Testo alternativo figura: retta orientata verso destra con 
indicati i numeri interi da -6 a +6 per rappresentare graficamente 
l'addizione tra -3 e +5, ossia si parte da -3 e si fanno cinque salti 
verso destra, fermandosi pertanto a +2.}
  {\intaddlinea}
% 
% \vspace{-2.5em}
\[ (-1)+(-3) = -4\]
...
\immagine[.8]{Testo alternativo figura: retta orientata verso destra con 
indicati i numeri interi da -6 a +6 per rappresentare graficamente 
l'addizione tra -1 e -35, ossia si parte da -1 e si fanno tre salti verso 
sinistra, fermandosi pertanto a -4.}
{\intaddlineb}
...
\immagine[.8]{Testo alternativo figura: retta orientata verso destra con 
indicati i numeri interi da -6 a +6 per rappresentare graficamente la 
sottrazione tra +5 e -+7, ossia si parte da +5 e si fanno sette salti 
verso sinistra, fermandosi pertanto a -2.}
{\intsublinea}
...
\hspace{-7mm}
\immagine*[.8]
{Testo alternativo figura: si consideri \((+2)-(+3)=(+2)+(-3)\), ossia 
cambio la sottrazione in addizione e cambio il segno del secondo operando.}
{\sottrazioneint}
}
...
\immagine[.8]
{Testo alternativo figura: rappresentazione sulla retta orientata verso 
destra, con indicati i numeri da -6 a +6, della somma algebrica 
...
\(= +26 - 20 = +6\)
\end{esempio}
\immagine*{Testo alternativo: annullo i termini opposti significa che li 
elimino, ossia visivamente ciascuno di questi numeri viene barrato con 
una riga diagonale dal basso a sinistra verso l'alto a destra; i numeri 
in questione sono +13 e -13, +60 e -60.}{}
...
\immagine*{Testo alternativo figura: tabella formata da 3 righe e 3 
colonne. 
Nella cella in alto a sinistra (intestazione prima colonna) è riportato 
il simbolo della moltiplicazione, nelle altre due intestazioni di colonna 
il segno dei fattori "+" e il segno "-", lo stesso per le intestazioni di 
riga; pertanto all'incrocio c'è il segno del risultato e quindi partendo 
dalla seconda riga i segni "+" e "-", nella terza riga i segni "-" e "+".}
{}
...
\immagine*{Testo alternativo: dopo il terzo uguale si linea di frazione, 
al numeratore 1 per a per m volte e al denominatore 1 per a m volte per a 
per n-m volte e facendo le opportune semplificazioni si ottiene linea di 
frazione, al numeratore 1 e al denominatore a elevato alla n-m.}{}
