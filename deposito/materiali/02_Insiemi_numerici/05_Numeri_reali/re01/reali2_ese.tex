...
\midrule
\(\valass{x}<\valass{y}\)& \verofalso & \verofalso& \verofalso& \verofalso\\
\(\valass{x}=\valass{y}\)& \verofalso & \verofalso& \verofalso& \verofalso\\
\(\valass{x}<y\)& \verofalso & \verofalso& \verofalso& \verofalso\\ 
\(\valass{x+y}<\valass{x}+\valass{y}\)& \verofalso & \verofalso& \verofalso& 
\verofalso\\
\(\valass{x-y}=\valass{x}-\valass{y}\)& \verofalso & \verofalso& \verofalso& 
\verofalso\\
