...
\item \myp 
\funzpolese{.25*\x*\x*\x*\x-2*\x*\x+2}{-3}{+3} \\[-1.2em] %1C % Non funziona \x**4!!!
\item \myp 
...
\item \(y = \dfrac{1}{4}x+2\) \\[-1.1em] %2A
\item \(y = -\dfrac{1}{4}x^2-2x+2\) \\[-1.1em] %2B
\item \(y = \dfrac{1}{4}x^4-2x^2+2\) \\[-1.1em] %2C
\item \(y = -\dfrac{1}{5}x^3-1\) \\[-1.1em] %2D
\item \(y = \dfrac{1}{5}x^5-1\) \\[-1.1em] %2E
\item \(y = -\dfrac{1}{5}x^3+\dfrac{1}{5}x^2+2x-1\) \\[-1.1em] %2F
\end{itemize}
\end{htmulticols}
\end{esercizio}
