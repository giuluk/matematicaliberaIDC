...
\newcommand{\cubobina}{% Cubo composto
  \cubobin{3}{1}{0}
}

\newcommand{\cubobinb}{% Cubo scomposto
  \cubobin{3}{1}{1.4}
}
...
\newcommand{\funzpol}{
  \disegno[10]{
    \rcom{-1}{+3}{-2}{+4}
    \fpunti{4*\x*\x*\x -10*\x*\x +6*\x}
      {blue!50!black}{-0.2, -0.1, ...,2}
  }
}
...
\newcommand{\funzpolese}[3]{
  ...
  \disegno[\dimdis]{
    ...
    \rcom{-\mima}{+\mima}{-\mima}{+\mima}
    \fpunti{\fun}{blue!50!black}{#2, ...,#3}
  }
}
