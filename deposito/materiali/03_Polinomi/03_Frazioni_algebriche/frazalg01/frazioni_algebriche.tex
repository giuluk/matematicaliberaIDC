...
\subsection{Massimo Comun Divisore}\indc{polinomio/polinomi}{MCD di polinomi}
...
\subsection{Minimo comune multiplo}\indc{polinomio/polinomi}{mcm di polinomi}
...
fattori è nullo\ind{annullamento del prodotto}.
\end{teorema}
