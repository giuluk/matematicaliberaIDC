...
irriducibili\indc{polinomio/polinomi}{fattori irriducibili di un polinomio}.
...
polinomio~\(B\)\indc{polinomio/polinomi}{polinomio multiplo di polinomio} se 
...
una \indt{frazione algebrica}, cioè una frazione che ha un polinomio al 
...
uno dei fattori è nullo\ind{annullamento del prodotto}.
\end{teorema}
...
Calcola il prodotto delle frazioni algebriche:\\
\central{
\(f_{1}=-{\dfrac{3a}{2b+1}}\) ~~e~~ \(f_{2}=\dfrac{10b}{a-3}\)}\\ [-.5em]
...
a patto che il divisore sia diverso da zero\indc{f.algebriche}{divisione di 
f.algebriche}.
...
\section{Potenza di una frazione algebrica}\indc{f.algebriche}{potenza di una 
f.algebrica}
