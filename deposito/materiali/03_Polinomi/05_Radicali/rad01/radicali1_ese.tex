...
% \item \(\sqrt{24336}\)
% \item \(\small\sqrt[5]{34-\sqrt[4]{14+\sqrt{2+\sqrt[3]8}}}\)
\end{enumeratea}
\end{htmulticols}
\noindent\!\sframeop{b} \(2\);~ 
\sframeop{a} \(5\);~ 
\sframeop{h} \(25\);~ 
\sframeop{c} \(3\);~ 
\sframeop{d} \(0,2\);~ 
...
\subsubsection*{\numnameref{sec:radicali_operare}}
...
%  \item \(\sqrt[6]{121}\)
% %  \item \(\sqrt[6]{125}\)
\item \(\sqrt[4]{49}\) \sol{\sqrt{7}}
\item \(\sqrt[6]{64}\) \sol{\sqrt{2}}
...
%   \hfill \(\left[...\right]\)
\item \(\sqrt[9]{-3^3}\) \sol{\sqrt[3]{-3}}
\item \(\sqrt[6]{(-2)^4}\) \sol{\sqrt[3]{4}}
\item \(\sqrt[12]{-4^6}\)
...
% c)~\(\left|a\right|\sqrt{\left|a-1\right|}\),\quad 
% d)~\(\valass{x-3}\),\quad 
...
% \subsubsection*{\numnameref{sec:alradici_operare}}
...
\hfill \(\left[0\right]\)
\item \(\sqrt[4]{162}-\sqrt[4]{32}+5\sqrt[3]{16}-\sqrt[3]{54}+
      \sqrt[3]{250}\)
...
%  \item \(\frac{3x-2}{\sqrt 8x-\sqrt{32}}+
% \frac{5x}{4\sqrt 3x-8\sqrt 3}=0\).
%  \end{enumeratea}
%  \end{htmulticols}
% \end{esercizio}
...
% %-------------2.81
% (301) a R. \(-\frac{\sqrt 2+2\sqrt 3} 3\) 
% (302) b R. \(\frac{\sqrt 2} 2\) 
% (303) c R. \(\frac{36+17\sqrt 3}{30}\) 
% (304) d R. \(\frac{36-10\sqrt 6}{29}\)
% 
% \paragraph{\ref{ese:2.83}}
% a)~\(x<-\sqrt 2\),\, b)~\(x>\frac{\sqrt 2-6} 2\),\, 
% c)~\(x>\frac{\sqrt{10}(\sqrt 2-1)} 2\),\, d)~\(x<5\sqrt 3-\sqrt 6\),\, 
% e)~\(x\ge \frac{4\sqrt 3-4+\sqrt 6-\sqrt 2} 7\).
% ---------------2.83
% (305) a R. \(x<-\sqrt 2\) 
% (306) b R. \(x>\frac{\sqrt 2-6} 2\) 
% (307) c R. \(x>\frac{\sqrt{10}(\sqrt 2-1)} 2\) 
% (308) d R. \(x<5\sqrt 3-\sqrt 6\)
...
% a)~\(\emptyset\),\quad b)~\((\frac{9+9\sqrt 3} 2;\frac{1+\sqrt 3} 
% 2)\),\quad 
...
% a)~\((\frac{\sqrt 2+4} 5;\frac{\sqrt 2-2} 5)\),\quad b)~\((\sqrt 
% 2;-1)\),\quad 
% c)~\((-\frac{4\sqrt 2+12} 7;\frac{18\sqrt 2+12} 7)\),\quad 
% d)~\(\emptyset\).
% %---------------2.88
...
% a)~\(\R\),\quad b)~\((\frac{4\sqrt 5} 3;\frac{5\sqrt 5} 3)\),\quad 
...
% a)~\(\forall x\in \R\),\quad d)~\(\forall x\in \R\),\quad g)~\(-2<x<-1 
...
% \sqrt[6]{\frac{a^2-2a+1}{ab+b}}\cdot 
% \sqrt[4]{\frac{b^2(a-1)^2}{2a^2+4a+2}}\)
...
%  \item 
% \(\sqrt{\frac{25x^3+25x^2}{y^3-y^2}}+\sqrt{\frac{x^3+x^2}{y^3-y^2}}-
% x\sqrt{\frac{4x+4}{y^3-y^2}}\)
...
% \sqrt[12]{\frac{a^2-2a+1}{(a-1)^7}}:\sqrt[3]{\frac{2a^2-2a+1}{a^3-a^2}-
% \frac 1{a-1}}\)
%  \item \(\sqrt{\frac{a^2b+ab^2}{xy}}\cdot 
...
%  \item 
% \(\sqrt{4x-12y}+\sqrt{\frac{x^3-3x^2y}{y^2}}+
% \sqrt{\frac{xy^2-3y^3}{x^2}}\);
...
% %-----------------------2.61
% %(218) a \ (219) b \ (220) c R. \(\sqrt[5]{b^7}\) \ (221) d \ (222) e\ 
% %(223) 
...
% a)~\(\sqrt[3]{\frac{a-1}{(a+1)^2}}\),\; 
% b)~\(\sqrt[6]{\frac{27a^3}{a-3}}\),\; 
...
% \(\sqrt[3]{\frac{\sqrt{\frac a b-\frac b a}}
...
Data l'espressione 
\(E=\frac{2a-2\sqrt 2}{\sqrt 2}+\frac{(a+2)\cdot \sqrt 2} 2+
\frac 4{\sqrt 2}-1\), 
