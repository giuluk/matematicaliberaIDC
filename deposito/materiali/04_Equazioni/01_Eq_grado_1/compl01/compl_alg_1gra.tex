...
%  \item confrontando con le~\(\CE\), la soluzione appartiene 
all'insieme~\(\ID\), 
...
%     Osserviamo che per~\(x = -1\) oppure per~\(x = 2\) le frazioni perdono 
di 
...
Riprendiamo l'equazione  \(x+kx=2k\), raccogliamo a fattore comune la~\(x\) si 
ha:
\begin{equation*}
 (k+1)x=2k.
\end{equation*}
