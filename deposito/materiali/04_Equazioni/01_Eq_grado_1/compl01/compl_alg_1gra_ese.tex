...
%         \dfrac{2-3x}{2x-6}\cdot 
% {\dfrac{x^{2}-9}{4-9x^{2}}}-\dfrac{6x+7}{6}\)
...
\hfill \(\left[m=1\vee m=-1 \rightarrow \R; ~~ 
m\neq~1\wedge m\neq -1 \rightarrow \emptyset\right]\)
 \item \((a-2)^{2}x+(a-2)x+a-2=0\)
\hfill \(\left[a=2 \rightarrow \R; ~~ 
a=1 \rightarrow \emptyset; ~~ 
...
% \hfill \(\left[a=0 \rightarrow \R; \quad a\neq~0 \rightarrow \{0\}\right]\)
%  \item \(a^{3}x-a^{2}-4ax+4=0\)
% \hfill \(\left[a=-2\vee a=2 \rightarrow \R; \quad 
...
% \hfill \(\left[b=-3 \rightarrow \R; \quad 
...
% \begin{esercizio}[*]
% \label{ese:20.41}
% Risolvi e discuti le seguenti equazioni nell'incognita~\(x\) con due 
% parametri.
% \begin{htmulticols}{2}
% \begin{enumeratea}
%  \item \((m+1)(n-2)x=0\)
...
% \begin{esercizio}[*]
% \label{ese:20.44}
% Risolvi e discuti le seguenti equazioni che presentano il parametro al 
% denominatore.
% \begin{htmulticols}{2}
% \begin{enumeratea}
...
%  \item 
% \(\dfrac{x+2}{a^{2}-2a}+\dfrac{x}{a^{2}+2a}+\dfrac{1}{a}=
% \dfrac{2}{a^{2}-4}\)
% \end{enumeratea}
% \end{htmulticols}
% \end{esercizio}
...
% \begin{enumeratea}
%  \item 
% \(\dfrac{x+1}{a^{2}+2a+1}+\dfrac{2x+1}{a^{2}-a-2}-
% \dfrac{2x}{(a+1)(a-2)}+\dfrac{1}{a-2}=0\)
%  \item \(\dfrac{x+1}{a-5}+\dfrac{2x-1}{a-2}=\dfrac{2}{a^{2}-7a+10}\)
%  \item 
% \(\dfrac{x+2}{b-2}+\dfrac{2}{b^{2}-4b+4}+\left(\dfrac{1}{b-2}+
% \dfrac{x}{b-1}\right)\cdot (b-1)=0\)
%  \item 
% \(\dfrac{3+b^{3}x}{7b^{2}-b^{3}}+\dfrac{(2b^{2}+b)x+1}{b(b-7)}=
% \dfrac{3b^{2}x+1}{b^{2}}-2x\)
%  \item 
% \(\dfrac{x-2}{t^{2}+3t}+\dfrac{x-1}{t+3}=
% \dfrac{x-2}{t^{2}}+\dfrac{1}{t+3}\)
...
% \begin{enumeratea}
%  \item 
% \(\dfrac{x-a}{x^{2}-1}-\dfrac{x+3a}{2x-x^{2}-1}=
% \dfrac{x+5}{x+1}-2\dfrac{x}{(x-1)^{2}}-1\)
%  \item \(\dfrac{3}{1+3x}+\dfrac{a}{3x-1}=\dfrac{a-5x}{1-9x^{2}}\)
%  \item 
% \(\dfrac{2a}{x^{2}-x-2}+\dfrac{1}{3x^{2}+2x-1}=
% \dfrac{6a^{2}-13a-4}{3x^{3}-4x^{2}-5x+2}\)
...
% \dfrac{bx}{1-x^{2}}+\dfrac{a+2x^{2}}{x^{2}-1}\)
...
% 
% \paragraph{20.41.}
% a)~\(m=-1\vee n=2 \rightarrow \R; \quad m\neq -1\wedge n\neq~2 \rightarrow 
% \{0\}\)
% \protect\\
% b)~\(m=0\wedge n\neq~0 \rightarrow \emptyset; \quad m=0\wedge n=0 
% \rightarrow \R; \quad m\neq~0 \rightarrow \left\{\frac{m+n}{m}\right\}\)
% \protect\\
% c)~\(a=-1\vee b=-1 \rightarrow \R; \quad a\neq -1\wedge b\neq -1 \rightarrow 
% \{0\}\)
% \protect\\ d)~\(m=n=0 \rightarrow \R; \quad m=-n\neq~0 \rightarrow 
% \emptyset; \quad m\neq -n \rightarrow \left\{\frac{2m}{m+n}\right\}\)
% 
% \paragraph{20.42.}
% a)~\(a=b=0 \rightarrow \R; \quad a=-b\neq~0 \rightarrow \emptyset; \quad 
% a\neq -b \rightarrow \left\{\frac{2(b-a)}{a+b}\right\}\)
% \protect\\ b)~\(a=2\wedge b=-3 \rightarrow \R; \quad a=2\wedge b\neq -3 
% \rightarrow \emptyset; \quad a\neq~2 \rightarrow 
% \left\{\frac{b+3}{a-2}\right\}\)
% \protect\\ c)~\(a=-1\wedge b=-1 \rightarrow \R; \quad a=-1\wedge b\neq -1 
% \rightarrow \emptyset; \quad a\neq -1 \rightarrow 
% \left\{\frac{b+1}{a+1}\right\}\)
% \protect\\ d)~\(a=b=0 \rightarrow \R; \quad a=b\neq~0 \rightarrow 
% \emptyset; 
% \quad a\neq b \rightarrow \left\{\frac{2b-a}{a-b}\right\}\)
% 
% \paragraph{20.43.}
% a)~\(a=-{\frac{2}{3}}\wedge b=0 \rightarrow \R; \quad a=-{\frac{2}{3}}
% \wedge 
% b\neq~0 \rightarrow \emptyset; \quad a\neq -{\frac{2}{3}} \rightarrow 
% \left\{\frac{b}{2+3a}\right\}\)
% \protect\\ b)~\(a=0\wedge b=0 \rightarrow \R; \quad a=0\wedge b\neq~0 
% \rightarrow \emptyset; \quad a\neq~0 \rightarrow 
% \left\{-{\frac{b^{2}}{a}}\right\}\)
% 
% \paragraph{20.44.}
% a)~\(a=0 \rightarrow\) assurdo; \(a=-3 \rightarrow \emptyset; \quad 
% a\neq~0\wedge a\neq -3 \rightarrow \left\{\frac{3}{a+3}\right\}\)
% \protect\\ b)~\(b=0 \rightarrow\) assurdo; \(b=6 \rightarrow \emptyset; 
% \quad b\neq~0\wedge b\neq~6 \rightarrow \left\{\frac{1}{6-b}\right\}\)
% \protect\\ c)~\(a=0 \rightarrow\) assurdo; \(a=-2 \rightarrow \emptyset; 
% \quad a\neq~0\wedge a\neq -2 \rightarrow \left\{\frac{7}{2+a}\right\}\)
% \protect\\ d)~\(a=0\vee a=2 \rightarrow\) assurdo; \(a=-3 \rightarrow 
% \emptyset; \quad a\neq~0\wedge a\neq~2\wedge a\neq -3 \rightarrow 
% \left\{\frac{a+2}{a+3}\right\}\)
% 
% \paragraph{20.45.}
% a)~\(a=1\vee a=3 \rightarrow\) assurdo; \(a\neq~1\wedge a\neq~3 
% \rightarrow 
% \{2(a-1)(a-3)\}\),
% \protect\\ b)~\(a=0\vee a=1 \rightarrow\) assurdo; \(a=\frac{1}{2} 
% \rightarrow \emptyset; \quad a\neq~0\wedge a\neq \frac{1}{2}\wedge a\neq~1 
% \rightarrow \left\{\frac{1}{2a-1}\right\}\)
% \protect\\ c)~\(a=-2 \rightarrow\) assurdo; \(a=-3 \rightarrow \emptyset; 
% \quad a=3 \rightarrow \R; \quad a\neq -3\wedge a\neq -2\wedge a\neq~3 
% \rightarrow \left\{\frac{a+2}{a+3}\right\}\)
% \protect\\ d)~\(a=0\vee a=-2\vee a=2 \rightarrow\) assurdo; 
% \(a\neq~0\wedge 
% a\neq -2\wedge a\neq~2 \rightarrow \left\{-{\frac{a}{2}}\right\}\)
% 
% \paragraph{20.46.}
% a)~\(a=2\vee a=-1 \rightarrow\) assurdo; \(a\neq~2\wedge a\neq -1 
% \rightarrow \left\{\frac{a(a+4)}{2-a}\right\}\)
% \protect\\ b)~\(a=5\vee a=2 \rightarrow\) assurdo; \(a=4 \rightarrow 
% \emptyset; \quad a\neq~5\wedge a\neq~2\wedge a\neq~4 \rightarrow 
% \left\{\frac{1}{3(4-a)}\right\}\)
% \protect\\ c)~\(b=2\vee b=1 \rightarrow\) assurdo; \(b\neq~2\wedge b\neq~1 
% \rightarrow \left\{\frac{b}{2-b}\right\}\)
% \protect\\ d)~\(b=0\vee b=7\rightarrow\) assurdo; \(b\neq~0\wedge b\neq~7 
% \rightarrow \left\{-{\frac{1}{2b^{2}}}\right\}\)
% \protect\\ e)~\(t=0\vee t=-3 \rightarrow\) assurdo; \(t^{2}=3 \rightarrow 
% \R; \quad t\neq~0\wedge t\neq -3\wedge t^{2}\neq~3 \rightarrow \{2\}\)
% \protect\\ f)~\(a=0\vee a=\frac{1}{2} \rightarrow\) assurdo; 
% \(a\neq~0\wedge 
% a\neq \frac{1}{2} \rightarrow \{2-6a\}\)
% 
% \paragraph{20.47.}
% a)~\(t=0\vee t=1 \rightarrow \emptyset; \quad t\neq~0\wedge t\neq~1 
% \rightarrow \left\{\frac{5t-1}{2t}\right\}\)
% \quad b)~\(m=1 \rightarrow \R-\{-1\}; \quad m\neq~1 \rightarrow 
% \emptyset\)
% \quad c)~\(a=\frac{1}{2} \rightarrow \emptyset; \quad a\neq \frac{1}{2} 
% \rightarrow \left\{-{\frac{2(a-2)}{2a-1}}\right\}\)
% \protect\\ d)~\(a=3\vee a=\frac{7}{9} \rightarrow \emptyset; \quad 
% a\neq~3\wedge a\neq \frac{7}{9} \rightarrow 
% \left\{\frac{2(3a+1)}{3-a}\right\}\)
% 
% \paragraph{20.48.}
% a)~\(k=-1 \rightarrow\) assurdo; \(k=1 \rightarrow \emptyset; \quad 
% k\neq~1\wedge k\neq -1 \rightarrow 
% \left\{-{\frac{\left(k^2-1\right)}{2}}\right\}\)
% \protect\\ b)~\(k=0 \rightarrow \R-\{1,-1\}; \quad k\neq~0 \rightarrow 
% \{-3\}\), c)~\(a=1 \rightarrow \R-\{-3,2\}; \quad a\neq~1 \rightarrow 
% \emptyset\)
...
% \quad b)~\(a=-{\frac{4}{3}}\vee a=\frac{5}{9}\vee a=\frac{13}{3} \rightarrow 
% \emptyset; \quad a\neq -{\frac{4}{3}}\wedge a\neq \frac{5}{9}\wedge a\neq 
% \frac{13}{3} \rightarrow \left\{\frac{3-2a}{4+3a}\right\}\)
% \protect\\ c)~\(a=-{\frac{1}{6}} \rightarrow 
% \R-\left\{-1,2,\frac{1}{3}\right\}; \quad a=\frac{7}{3}\vee a=4\vee a=1 
% \rightarrow \emptyset; \quad a\neq -{\frac{1}{6}}\wedge a\neq 
% \frac{7}{3}\wedge a\neq~4\wedge a\neq~1 \rightarrow \{a-2\}\)
...
% \rightarrow \left\{-{\frac{\ a^{2}}{1+a}}\right\}\)
% \protect\\ b)~\(a=-1\vee a=0 \rightarrow \emptyset; \quad a\neq -1\wedge 
% a\neq~0 \rightarrow \left\{-{\frac{a(a-1)}{a+1}}\right\}\)
% \quad c)~\(a=0 \rightarrow \R-\{0\}; \quad a\neq~0 \rightarrow \{0\}\)
% \quad d)~\(a=0 \rightarrow \emptyset; \quad a\neq~0 \rightarrow 
% \left\{-{\frac{5}{a}}\right\}\)
% 
% \paragraph{20.51.}
% a)~\(a=1 \rightarrow\) assurdo; \(a=-1 \rightarrow \emptyset; \quad 
% a\neq~1\wedge a\neq -1 \rightarrow \left\{\frac{4}{a+1}\right\}\)
% \protect\\ b)~\(t=-1 \rightarrow\) assurdo; \(t\neq -1 \rightarrow 
% \left\{\frac{1}{t+1}\right\}\)
% \protect\\ c)~\(t=-1 \rightarrow\) assurdo; \(t=0 \rightarrow \R-\{2\}; 
% \quad t=-{\frac{1}{2}} \rightarrow \emptyset; \quad t\neq -\frac{1}{2}
% \wedge 
% t\neq -1\wedge t\neq~0 \rightarrow \left\{\frac{3t+1}{2t+1}\right\}\)
% \quad d)~\(a=-1 \rightarrow\) assurdo; \(a=2 \rightarrow \emptyset; \quad 
...
% \dfrac{4(1-3x)^{2}}{2}-y=
% \dfrac{(12x-5)(6x-y)}{4}+3xy+2\end{array}\right.\)
...
% Per quali valori di~\(a\) la coppia soluzione è formata da numeri reali 
% positivi?
% 
% \(\left\{\begin{array}{l}
% {x+ay=2a}\\
...
% \hfill 
% \(\left[\left(\frac{3}{2};~-\frac{2}{7};~-\frac{1}{14}\right)\right]\)
% \item \(\left\{\begin{array}{l}
% x-3y+6z=1 \\
% x+y+z=5 \\
% x+2z=3 \end{array}\right.\)
...
% \end{array}\right.\)
% \hfill 
% \(\left[\left(\frac{9}{31};~\frac{17}{31};~-\frac{5}{31}\right)\right]\)
% \item \(\left\{\begin{array}{l}
...
% \end{array}\right.\)
% \hfill \(\left[\left(-{\frac{60}{43}};~-\frac{53}{43};~\frac{47}{43}
% \right)
%         \right]\)
% \item \(\left\{\begin{array}{l}
...
% accettabile:
% \[\arraystretch{2}\left\{\begin{array}{l}\frac{5}{1-x}+\frac{3}{y+2}=
% \frac{2x}{xy-2+2x-y}\\
...
% \item \(\left(-{\frac{6}{11}}+2x\right)\cdot\left(-x+\frac{9}{2}\right) 
% \le 0\)
...
% \item \((3x+2)(2-3x)<0\) \hfill \(\left[x<-{\frac{2}{3}}\vee 
% x>\frac{2}{3}\right]\)
...
%  \item \(x^{2}+6x+9\ge~0\) \hfill \(\left[\R\right]\)
...
% \item \(x^{3}-2x^{2}-x+2\ge~0\) \hfill \(\left[-1\le x\le~1\vee 
% x\ge~2\right]\)
% \item \(x^{4}+4x^{3}+3x^{2}>0\) \hfill \(\left[x<-3\vee x>-1\wedge 
% x\neq~0\right]\)
% \item \((6x^{2}-24x)(x^{2}-6x+9)<0\) \hfill \(\left[0<x<4\wedge 
% x\neq~3\right]\)
% \item \((x^{3}-8)(x+2)<(2-x)(x^{3}+8)\) \hfill \(\left[-2<x<2\right]\)
% \item \((2a+1)(a^{4}-2a^{2}+1)<0\) \hfill \(\left[a<-{\frac{1}{2}}\wedge 
% a\neq -1\right]\)
% \item \(x^{3}-6x^{2}+11>1-3x\) \hfill \(\left[-1<x<2\vee x>5\right]\)
% \item \(x^{6}-x^{2}+x^{5}-6x^{4}-x+6<0\) \hfill 
% \(\left[-3<x<-1\vee~1<x<2\right]\)
% \end{enumeratea}
% \end{esercizio}
% 
% \begin{esercizio}[*]
...
% \emph{Traccia di svolgimento}. Scomponi in fattori numeratore e 
% denominatore, 
% otterrai
...
% x^{2}-4\le~0
% \end{array}\right.\)
% \hfill \(\left[\left\{x\in\R/x=-2\right\}\right]\)
% \item \(\left\{\begin{array}{l}
% \dfrac{x^{2}-4x+4}{9-x^{2}}>0\\
% x^{2}-3x\le~0
% \end{array}\right.\)
% \hfill \(\left[\left\{x\in \R/0\le x<3 \wedge x\neq~2\right\}\right]\)
% \item \(\left\{\begin{array}{l}
...
% \item \(\left\{\begin{array}{l}
% 
% \left(1+\dfrac{2}{x-2}\right)\left(1-\dfrac{2}{x-2}\right)<
% \dfrac{x-4}{2-x}\\
% 
...
% a>\frac{1}{5}\right\}\) \tab\verofalso
% \item \(f_{4}\) è positiva per qualunque valore reale attribuito alla 
% variabile \tab\verofalso
% \item nell'intervallo~\({[}-\frac{1}{2},\frac{1}{2}{[}\), \(f_{5}\) non si 
% annulla \tab\verofalso
...
% 
% \paragraph{22.9.} a)~\((4;5)\), b)~indeterminato, c)~\((1;-1)\), 
% d)~\((-4;2)\)
% 
% \paragraph{22.10.} a)~indeterminato, b)~\((4;5)\), c)~impossibile, 
% d)~indeterminato.
% 
% \paragraph{22.11.} a)~\((-66;-12)\), b)~\((2;3)\), d)~\((0;0)\)
% 
% \paragraph{22.12.} a)~\(\left(-{\frac{9}{8}};-\frac{9}{8}\right)\), 
% b)~\(\left(\frac{28}{17};\frac{6}{17}\right)\), d)~\((1;-3)\)
% 
% \paragraph{22.13.} a)~\(\left(-4;-{\frac{3}{2}}\right)\), 
% c)~\(\left(\frac{1}{6};\frac{35}{24}\right)\)
% 
% \paragraph{22.16.} a)~\((0;0)\), b)~\((2;-1)\), c)~\((2;1)\), 
% \protect\\d)~\((-1;-3)\)
% 
% \paragraph{22.17.} a)~impossibile, c)~impossibile, d)~indeterminato.
% 
% \paragraph{22.18.} a)~\(\left(\frac{2}{3};0\right)\), 
% b)~\(\left(-{\frac{1}{5}};\frac{1}{5}\right)\), c)~\((3;4)\), d)~\((0;1)\)
% 
% \paragraph{22.20.} a)~\((0;0)\), b)~\((0;1)\), 
% c)~\(\left(\frac{1}{2};0\right)\), 
% d)~\(\left(-{\frac{1}{2}};\frac{1}{2}\right)\)
% 
% \paragraph{22.21.} a)~\((1;1)\), b)~\((1;1)\), 
% c)~\(\left(\frac{35}{12};\frac{19}{12}\right)\), 
% \protect\\d)~\(\left(-{\frac{12}{11}};\frac{7}{11}\right)\)
% 
% \paragraph{22.22.} a)~\((-11;-31)\), b)~\((1;1)\), c)~\((1;2)\)
% 
% \paragraph{22.26.} a)~\((2;0)\), 
% b)~\(\left(\frac{13}{12};\frac{5}{12}\right)\), 
% c)~\(\left(-{\frac{12}{11}};\frac{7}{11}\right)\), 
% d)~\(\left(0;-\frac{1}{2}\right)\)
% 
% \paragraph{22.27.} a)~\((21,-12)\), 
% b)~\(\left(-{\frac{240}{19}};\frac{350}{19}\right)\), 
% c)~\(\left(\frac{34}{37};\frac{16}{37}\right)\), 
% d)~\(\left(1;\frac{7}{3}\right)\)
% 
% \paragraph{22.28.} a)~\(\left(-1;0\right)\), 
% b)~\(\left(\frac{1}{2};-1\right)\), 
% c)~\(\left(\frac{3}{10};\frac{7}{10}\right)\), 
% d)~\(\left(-{\frac{1}{4}};\frac{1}{6}\right)\)
% 
% \paragraph{22.29.} a)~impossibile, b)~indeterminato, \protect\\ 
% c)~\((a;2a)\), d)~\((2k;-k)\)
% 
% \paragraph{22.39.} a)~rette parallele, sistema impossibile, b)~\((-3;-8)\), 
% c)~rette identiche, indeterminato, d)~\((2;2)\)
% 
% \paragraph{22.40.} a)~\(\left(-1;0\right)\), b)~\((2;0)\), 
% c)~\(\left(-1;0\right)\), d)~rette parallele, impossibile.
% 
% \paragraph{22.41.} a)~\(\left(0;-\frac{1}{2}\right)\), b)~\((1;1)\), 
...
% g)~\(\R \),\quad h)~\(\emptyset \)
% 
% \paragraph{21.12.} a)~\(\emptyset \),\quad b)~\(\R\),\quad
...
% \protect\\g)~\(x>-{\frac{27}{5}}\),\quad h)~\(\R\)
% 
% \paragraph{21.14.} a)~\(x<-{\frac{3}{4}}\),\quad b)~\(\R\),\quad
% c)~\(x\ge -{\frac{13}{6}}\),\quad d)~\(x>\frac{3}{2}\),\quad
% e)~\(x>1\),\quad f)~\(x\ge~0\),\quad\protect\\
% g)~\(\{x\in\R/x<1\}=(-\infty,1)\),\quad h)~\(x<\frac{13}{2}\)
% 
% \paragraph{21.15.} a)~\(\R\),\quad b)~\(x>-{\frac{10}{111}}\),\quad
% c)~\(\emptyset \),\quad d)~\(\R\)
% 
% \paragraph{21.16.} \(x>5\)
% 
...
% 
% \paragraph{21.18.} Massimo~\(294\munit{km}\)
% 
...
% 
% \paragraph{21.26.} Più di~\(300\munit{km}\)
% 
% \paragraph{21.28.} \(x>310\munit{cm}\)
% 
% \paragraph{21.29.} \(\frac{7}{5}\munit{cm}<x<\frac{17}{5}\munit{cm}\)
% 
% \paragraph{21.30.} \(0^{\circ}<\alpha<45^{\circ}\)
% 
% \paragraph{21.31.} \(h\le \frac{150}{7}m\)
% 
% \paragraph{21.32.} Il lato minore tra~\(10\munit{m}\) e~\(100\munit{m}\), 
% il lato maggiore tra~\(20\munit{m}\) e~\(200\munit{m}\)
% 
% \end{htmulticols}
