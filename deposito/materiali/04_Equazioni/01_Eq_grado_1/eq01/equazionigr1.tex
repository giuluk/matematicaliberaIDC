...
\begin{definizione}{}{}
\ind{equazione} \ind{primo membro, secondo membro} \ind{soluzioni}
...
\ind{risolvere equazioni lineari}
...
\begin{osservazione}{}{} \ind{equazione in forma canonica}
...
Enunciamo alcune \emph{regole pratiche} \ind{regole pratiche per la soluzione}
...
\label{sec:13_coefffraz} \ind{equazione a coefficienti frazionari}
...
\ind{risolvere eq. di grado riducibile al primo}
...
\ind{equazione impossibile} \ind{equazione indeterminata}
\ind{equazione determinata}
...
\ind{Gauss}
all'età di tre anni avrebbe corretto un errore di suo padre nel calcolo
delle sue finanze.
...
``forma matematica'', quando cioè è possibile trascrivere in simboli
le relazioni che intercorrono tra le grandezze del problema.
...
\immagine[1]{triangolo rettangolo d ipotenusa BC.}{\equaztriangolo}
}
