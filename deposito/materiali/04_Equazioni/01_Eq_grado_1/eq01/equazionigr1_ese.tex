...
%   \left(\dfrac{3x-1}{3}\right)^{2}-\left(1-\dfrac{1}{3}x\right)x+
%         \dfrac{1}{3}x={\dfrac{1}{3}}(2x+1)^{2} \\
%   +\dfrac{1}{4}x^{2}-\dfrac{5}{9}+\dfrac{1}{2}x\left(\dfrac{1}{2} 
%    x+1\right)
...
% [11-12][S-A11], pg.~90;
% licenza CC,BY-NC-BD, per gentile concessione dei professori che hanno 
% redatto il libro.
...
\begin{esercizio}[*]
\label{ese:14.18}
La somma tra un numero ed il suo consecutivo aumentato di~\(1\) è uguale 
a~\(18\) 
...
\begin{esercizio}
\label{ese:14.19}
La somma tra un numero e lo stesso numero aumentato di~\(3\) è uguale a~\(17\) 
Qual 
...
\begin{esercizio}[*]
\label{ese:14.20}
La terza parte di un numero aumentata di~\(3\) è uguale a~\(27\) Trova il 
numero. 
\hfill \(\left[72\right]\)
\end{esercizio}
...
% \begin{esercizio}[*]
% \label{ese:14.21}
% La somma tra due numeri~\(x\) e~\(y\) vale~\(80\) Del numero~\(x\) sappiamo 
% che 
% questo 
% stesso numero aumentato della sua metà è uguale a~\(108\) \hfill 
% \(\left[\right]\)
% \end{esercizio}
% 
% \begin{esercizio}[*]
...
% numero~\(x\) è uguale a se stesso diminuito di~\(50\) e poi moltiplicato 
% per~\(6\) 
% Il numero~\(y\) aumentato di~\(60\) è uguale a se stesso diminuito di~\(40\) e 
% poi 
...
% \begin{esercizio}
% \label{ese:14.25}
% Trova tre numeri dispari consecutivi tali che la loro somma sia uguale 
% a~\(87\) 
% \hfill \(\left[\right]\)
% \end{esercizio}
% 
...
% \begin{esercizio}[*]
% \label{ese:14.34}
% Di~\(y\) sappiamo che il suo triplo è uguale al suo quadruplo diminuito 
% di~\(2\) 
...
% \begin{esercizio}
% \label{ese:14.35}
% Il numero~\(z\) aumentato di~\(60\) è uguale a se stesso diminuito di~\(30\) 
% e 
...
% è~\(\frac{2}{3}\) di quella delle unità, la cifra delle decine 
% è~\(\frac{1}{3}\) 
...
\begin{esercizio}[*]
\label{ese:14.58}
Cinque fratelli si devono spartire un'eredità di \officialeuro\(180000\) in 
modo 
...
% \begin{esercizio}[*]
% \label{ese:14.66}
% Si devono distribuire \officialeuro~\(140800\) fra~\(11\) persone che hanno 
% vinto 
...
% stati dati \officialeuro~\(4800\) euro in più, quante sono le persone che 
% hanno 
...
% di~\(120\munit{km/h}\) Dopo~\(80\) minuti parte un secondo treno dalla stessa 
% stazione e nella stessa direzione alla velocità di~\(150\munit{km/h}\) Dopo 
% quanti~\(\munit{km}\) il secondo raggiungerà il primo? 
% \hfill \(\left[800 \munit{km}\right]\)
% \end{esercizio}
% 
% \begin{esercizio}[*]
% \label{ese:14.68}
...
% \begin{esercizio}[*]
% \label{ese:14.69}
% Uno studente compra~\(4\) penne, \(12\) quaderni e~\(7\) libri per un totale 
% di 
% \officialeuro~\(180\) Sapendo che un libro costa quanto~\(8\) penne e 
% che~\(16\) 
...
% \begin{esercizio}[*]
% \label{ese:14.70}
% Un mercante va a una fiera, riesce a raddoppiare il proprio capitale e vi 
% spende \officialeuro~\(500\) a una seconda fiera triplica il suo avere e 
% spende 
% \officialeuro~\(900\) a una terza poi quadruplica il suo denaro e spende 
% \officialeuro~\(1200\) Dopo ciò gli sono rimasti \officialeuro~\(800\) Quanto 
% era 
...
% \begin{esercizio}[*]
% \label{ese:14.73}
% La massa di una botte colma di vino è di~\(192\munit{kg}\) mentre se la 
% botte è 
% riempita di vino per un terzo la sua massa è di~\(74\munit{kg}\) Trovare la 
% massa 
% della botte vuota.
% \end{esercizio}
% 
...
% di~\(400\munit{km}\), ma in senso opposto. Sapendo che partono alla stessa 
% ora 
% dagli estremi del percorso e che Carlo corre a~\(120\munit{km/h}\) mentre 
% Luigi 
% viaggia a~\(80\munit{km/h}\), calcolare dopo quanto tempo si incontrano.
% \end{esercizio}
% 
% \begin{esercizio}[*]
% \label{ese:14.75}
% Un fiorista ordina dei vasi di stelle di Natale che pensa di rivendere a 
% \officialeuro~\(12\) al vaso con un guadagno complessivo di 
% \officialeuro~\(320\) 
...
% \begin{esercizio}[*]
% \label{ese:14.76}
% Un contadino possiede~\(25\) tra galline e conigli; determinare il loro 
% numero 
...
% \begin{esercizio}[*]
% \label{ese:14.77}
% Un commerciante di mele e pere carica nel suo autocarro~\(139\) casse di 
% frutta 
% per un peso totale di~\(23,5\) quintali. Sapendo che ogni cassa di pere e 
% mele 
% pesa rispettivamente~\(20\munit{kg}\) e~\(15\munit{kg}\), determinare il 
% numero di 
...
% \begin{esercizio}[*]
% \label{ese:14.78}
% Determina due numeri uno triplo dell'altro sapendo che dividendo il 
% maggiore 
...
% margherita. 
% Tre volte la differenza dei due numeri vola sui fiori di pesco, e rimane 
% una 
...
% autobus, 
% alcuni con~\(40\) posti a sedere e altri con~\(52\) quanti sono gli autobus 
% di 
% ciascun tipo?
% \end{esercizio}
% 
...
% \begin{esercizio}[*]
% \label{ese:14.87}
% Un triangolo isoscele ha il perimetro di~\(188\munit{cm}\), la somma dei due 
% lati obliqui supera di~\(25\munit{cm}\) i~\(\frac{2}{3}\) della base. 
% Calcola la lunghezza dei lati. 
% \hfill \(\left[97,8\munit{cm};~45,1\munit{cm};~45,1\munit{cm}\right]\)
% \end{esercizio}
% 
% \begin{esercizio}[*]
% \label{ese:14.88}
% In un trinagolo~\(ABC\) di perimetro~\(186\munit{cm}\) il lato~\(AB\) 
% è~\(\frac{5}{7}\) 
% di~\(AC\) e~\(BC\) è~\(\frac{3}{7}\) di~\(AC\) Quanto misurano i lati del 
% triangolo?
%  \hfill \(\left[32,82\munit{cm};~45,95\munit{cm};~107,22\munit{cm}\right]\)
% \end{esercizio}
...
% \begin{esercizio}[*]
% \label{ese:14.101}
% Le due dimensioni di un rettangolo differiscono di~\(4\munit{cm}\) Trovare la 
% loro misura sapendo che aumentandole entrambe di~\(3\munit{cm}\) l'area del 
% rettangolo 
% aumenta di~\(69\munit{cm^2}\) \hfill \(\left[12\munit{cm};~8\munit{cm}\right]\)
% \end{esercizio}
% 
% \begin{esercizio}[*]
% \label{ese:14.102}
% In un quadrato~\(ABCD\) il lato misura~\(12\munit{cm}\) Detto~\(M\) il punto medio 
...
% \hfill \(\left[DN=2\munit{cm}\right]\)
% \end{esercizio}
% 
% \begin{esercizio}[*]
% \label{ese:14.103}
% Nel rombo~\(ABCD\) la somma delle diagonali è~\(20\munit{cm}\) ed il loro rapporto 
...
%  \hfill \(\left[AP=6\munit{cm}\right]\)
% \end{esercizio}
% 
% \begin{esercizio}
% \label{ese:14.104}
% In un rettangolo~\(ABCD\) si sa che~\(\overline{AB}=91\munit{m}\) 
% e~\(\overline{BC}=27\munit{m}\) dal punto~\(E\) del lato~\(AB\), traccia la 
