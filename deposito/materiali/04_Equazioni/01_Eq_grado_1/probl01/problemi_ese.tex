...
% \begin{esercizio}[\Ast, \croce]
% \label{ese:14.73}
% La massa di una botte colma di vino è di~\(192\munit{kg}\) mentre se la botte 
è 
...
\officialeuro~\(320\) Le 
% piantine però sono più piccole del previsto, per questo è costretto a 
rivendere 
% ogni vaso a \officialeuro~\(7\) rimettendoci complessivamente 
\officialeuro~\(80\) 
...
lati 
% obliqui supera di~\(25\munit{cm}\) i~\(\frac{2}{3}\) della base. Calcola la 
lunghezza 
% dei lati. \hfill 
...
% \begin{esercizio}[*]
% \label{ese:14.101}
% Le due dimensioni di un rettangolo differiscono di~\(4\munit{cm}\) Trovare la loro 
% misura sapendo che aumentandole entrambe di~\(3\munit{cm}\) l'area del rettangolo 
% aumenta di~\(69\munit{cm^2}\) \hfill \(\left[12\munit{cm};~8\munit{cm}\right]\)
% \end{esercizio}
% 
% \begin{esercizio}[*]
% \label{ese:14.102}
% In un quadrato~\(ABCD\) il lato misura~\(12\munit{cm}\) Detto~\(M\) il punto medio del 
