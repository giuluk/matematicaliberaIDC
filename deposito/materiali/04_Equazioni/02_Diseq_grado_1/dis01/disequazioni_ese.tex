...
\item \(\left\{\begin{array}{l}
    ...
    5\cdot\left(\dfrac{2}{3}x-\dfrac{1}{2}\right)\\
    x^2-2x+1\ge~0
   \end{array}\right.;\)
...
% \dfrac{x-4}{2-x}\\
% \left(\dfrac{2-x}{x^{2}-6x+9}+\dfrac{2+x}{x^{2}-9}\right)
...
% \hfill \(\left[x>310\munit{cm}\right]\)
%  \end{esercizio}
...
% il lato
% più piccolo? \hfill 
% \(\left[\dfrac{7}{5}\munit{cm}<x<\dfrac{17}{5}\munit{cm}\right]\)
%  \end{esercizio}
% 
%  \begin{esercizio}[*]
%  \label{ese:21.30}
...
% \hfill [Il lato minore tra~\(10\munit{m}\) e~\(100\munit{m}\), 
