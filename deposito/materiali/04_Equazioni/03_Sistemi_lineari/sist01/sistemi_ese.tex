...
% \[\arraystretch{2}\left\{\begin{array}{l}2x+\dfrac{1}{2}y=98
...
% \item 
% 
% \(\arraystretch{2}\left\{\begin{array}{l}3\dfrac{x}{y}-\dfrac{7}{y}=1\\
% 2\dfrac{y}{x}+\dfrac{5}{x}=1\end{array}\right.\)
% \item 
% 
% \(\arraystretch{2}\left\{\begin{array}{l}2\dfrac{x}{3y}-\dfrac{1}{3y}=1\\
% \dfrac{3}{y+2x}=-1\end{array}\right.\)
% \item 
% 
% \(\arraystretch{2}\left\{\begin{array}{l}\dfrac{x}{9y}=
%   -{\dfrac{1}{2}}+\dfrac{1}{3y}\\
% 9\dfrac{y}{2x}-1-\dfrac{3}{x}=0\end{array}\right.\)
% \item 
% 
% \(\arraystretch{2}\left\{\begin{array}{l}\dfrac{x}{2-\dfrac{y}{2}-2}=1\\
...
% 
% \(\arraystretch{2}
% \left\{\begin{array}{l}\dfrac{x-2y}{4}=\dfrac{\dfrac{x-y}{2}+2x}{4}\\
% \dfrac{x}{\dfrac{y}{3}+1}=1\end{array}\right.\)
% \item 
% \(\arraystretch{2}\left\{\begin{array}{l}\dfrac{x+3y-1}{x-y}=
% \dfrac{1}{y-x} \\x=2y-10 \end{array}\right.\)
% \item 
% 
% \(\arraystretch{2}
% \left\{\begin{array}{l}\dfrac{2}{x-2}-\dfrac{3}{y+3}=1\\\dfrac{5}{y+3
...
% 
% \(\arraystretch{2}
% \left\{\begin{array}{l}y-\dfrac{x}{3}+\dfrac{3}{4}=0\\
% \dfrac{2x+1}{1-x}+\dfrac{2+y}{y-1}=-1\end{array}\right.\)
% \item 
% 
% \(\arraystretch{2}\left\{\begin{array}{l}x+y=2\\
% y\left(\dfrac{x}{y}+3\right)=4
% \end{array}\right.\)
% \item 
% 
% \(\arraystretch{2}\left\{\begin{array}{l}\dfrac{x}{3}-\dfrac{y}{2}=0\\
% \dfrac{y(y-x-1)}{y+1}+x-y+1=\dfrac{1}{2}\end{array}\right.\)
% \item 
% 
% \(\arraystretch{2}\left\{\begin{array}{l}\dfrac{3x-7y+1}{4x^{2}-9y^{2}}=
% \dfrac{4}{18y^{2}-8x^{2}}\\
% \dfrac{4(1-3x)^{2}}{2}-y=\dfrac{(12x-5)(6x-y)}{4}+3xy+2\end{array}
% \right.\)
% \end{enumeratea}
% \end{esercizio}
% 
...
% 
% \(\arraystretch{2}
% \left\{\begin{array}{l}\dfrac{2x-3y}{x-2y}-\dfrac{3y-1}{x+5y}=
% \dfrac{2(x^{2}+2xy)-(3y-2)^{2}}{x^{2}+3xy-10y^{2}}\\
% x+y=-19\end{array}\right.\)
% \item 
% 
% \(\arraystretch{2}
% \left\{\begin{array}{l}\dfrac{x-3}{x-3y+1}+\dfrac{xy-y}{x-3y-1}=
...
% 
% \(\arraystretch{2}
% \left\{\begin{array}{l}\dfrac{x-2y}{x^{2}-xy-2y^{2}}-\dfrac{1}{y}=2\\
% \dfrac{4}{y}-\dfrac{5}{x+y}=-9\end{array}\right.\)
% \item 
% 
% \(\arraystretch{2}
% \left\{\begin{array}{l}{2x-y-11=0}\\
...
% 
% \(\arraystretch{2}
% \left\{\begin{array}{l}{\dfrac{x+1}{x}=\dfrac{y+2}{y-2}}\\
% {\dfrac{3x-1}{3x-2}=\dfrac{1+y}{y-2}}\end{array}\right.\)
% \item 
% 
% \(\arraystretch{2}
% \left\{\begin{array}{l}{\dfrac{2}{5x-y}=\dfrac{-3}{5y-x}}\\
% {\dfrac{1}{4x-3y}=\dfrac{2x+y-1}{3y-4x}}\end{array}\right.\)
% \item 
% 
% \(\arraystretch{2}
% \left\{\begin{array}{l}{\dfrac{\sqrt{3}}{x-\sqrt{2}}+
% \dfrac{2\sqrt{2}}{y-\sqrt{3}}=0}\\
% {\dfrac{1}{x-\sqrt{3}}-\dfrac{\sqrt{6}}{2\left(y+2\sqrt{2}\right)}=0}
% \end{array}\right.\)
% \item 
% 
% \(\arraystretch{2}
% \left\{\begin{array}{l}{\dfrac{x-y+1}{x+y-1}=2}\\
% {\dfrac{x+y+1}{x-y-1}=-2}\end{array}\right.\)
% \item 
% 
% \(\arraystretch{2}
% \left\{\begin{array}{l}{\dfrac{2}{x-2}=\dfrac{3}{y-3}}\\
...
% \[\left\{\begin{array}{l}{x+ay=2a}\\\dfrac{x}{2a}+y=\dfrac{3}{2}
% \end{array}
% \right.\]
% \end{esercizio}
% 
...
% accettabile?
% \[\left\{\begin{array}{l}3x-2y=0\\\dfrac{2x-y}{x+1}=\dfrac{1}{a}
% \end{array}
% \right.\]
% \end{esercizio}
% 
...
%  
% 
% \[\left\{\begin{array}{l}\dfrac{a-x}{a^{2}}+a+\dfrac{y-2a}{a+1}=-1\\
% 2y=x\end{array}\right.\]
% \end{esercizio}
% 
% 
% \begin{esercizio}
...
% \item 
% 
% \(\left\{\begin{array}{l}x+ay=2a\\\dfrac{x}{2a}+y=
% \dfrac{3}{2}\end{array}\right.\)
% \item 
% 
% \(\left\{\begin{array}{l}\dfrac{x^{3}-8}{x-2}=x^{2}-3x+y-2\\
...
% \item 
% \(\left\{\begin{array}{l}(k-1)x+(1-k)y=0\\
...
\begin{htmulticols}{2}
\begin{enumeratea}
\item \(\left\{\begin{array}{l}x-2y+z=1 \\x-y=2 \\x+3y-2z=0 
\end{array}\right.\)
 \hfill \(\left[(0;~-2;~-3)\right]\)
\item \(\left\{\begin{array}{l}x+y+z=4 \\x-3y+6z=1\\x-y-z=2 
\end{array}\right.\)
 \hfill \(\left[\left(3;\frac{8}{9};~\frac{1}{9}\right)\right]\)
\item 
\(\left\{\begin{array}{l}x+2y-3z=6-3y\\
2x-y+4z=x\\
3x-z=y+2\end{array}\right.\)
 \hfill \(\left[(1;~1;~0)\right]\)
\item \(\left\{\begin{array}{l}2x-y+3z=1 \\x-2y+z=5\\x+2z=3 
\end{array}\right.\)
 \hfill \(\left[(-21;~-7;~12)\right]\)
\item \(\left\{\begin{array}{l}x+2y-z=1 \\y-4z=0\\x-2y+z=2 
\end{array}\right.\)
 \hfill \(\left[\left(\frac{3}{2};~-\frac{2}{7};~-\frac{1}{14}\right)\right]\)
\item \(\left\{\begin{array}{l}x-3y+6z=1 \\x+y+z=5 \\x+2z=3 
\end{array}\right.\)
...
\item \(\left\{\begin{array}{l}4x-3y+z=4\\x+4y-3z=2 \\y-7z=0 
\end{array}\right.\)
...
\item \(\left\{\begin{array}{l}3x-y+z=-1\\x-y-z=3 \\x+y+2z=1 
\end{array}\right.\)
...
% \item 
% 
% \(\arraystretch{2}\left\{\begin{array}{l}\dfrac{1}{2x}+\dfrac{1}{y}=-4\\
% \dfrac{2}{3x}
...
% \item 
% 
% \(\arraystretch{2}\left\{\begin{array}{l}\dfrac{1}{x+y}+\dfrac{2}{x-y}=1\\
% \dfrac{3}{x+y}-\dfrac{5}{x-y}=2\end{array}\right.\)\quad 
...
% \item 
% 
% \(\left\{\begin{array}{l}\dfrac{5}{2x}-\dfrac{2}{y}=2\\
% \dfrac{1}{x}+\dfrac{2}{y}=1\end{array}\right.\)
% \item 
% 
% \(\left\{\begin{array}{l}\dfrac{1}{x}+\dfrac{2}{y}=3\\
% \dfrac{1}{x}+\dfrac{3}{y}=4\end{array}\right.\)
% \item 
% 
% \(\left\{\begin{array}{l}\dfrac{2}{x}+\dfrac{4}{y}=-3\\
% \dfrac{2}{x}-\dfrac{3}{y}=4 \end{array}\right.\)
% \item 
% 
% \(\left\{\begin{array}{l}\dfrac{1}{x+1}-\dfrac{2}{y-1}=2\\
% \dfrac{2}{x+1}-\dfrac{1}{y-1}=3\end{array}\right.\)}
% \end{enumeratea}
% \end{htmulticols}
% \end{esercizio}
% 
...
% 
% \(\arraystretch{2}
% \left\{\begin{array}{l}\dfrac{1}{x}-\dfrac{3}{y}+\dfrac{2}{z}=3 \\
...
% \end{array}\right.\)
% \item 
% \(\left\{\begin{array}{l}x^{2}+y^{2}=-1\\x^{2}-3y^{2}=
% 12\end{array}\right.\)
% % \item 
% 
% \(\arraystretch{2}
% \left\{\begin{array}{l}\dfrac{4}{x^{2}}-\dfrac{2}{y^{2}}-
% \dfrac{2}{z^{2}}=0\\
...
% è~\(16\munit{cm}\)
% \hfill \(\left[1536\munit{cm}^{2}\right]\)
% \end{esercizio}
% 
% \begin{esercizio}
%  \label{ese:22.112}
...
% \hfill \(\left[16\munit{cm};~24\munit{cm}\right]\)
% \end{esercizio}
% 
% \begin{esercizio}[*]
%  \label{ese:22.118}
...
% punto~\(P\).
% \hfill \(\left[7\munit{cm};~16\munit{cm}\right]\)
% \end{esercizio}
\end{htmulticols}
