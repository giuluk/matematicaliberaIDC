...
%  \item~\(0,09 x^{2} = 0,01\) \hfill\(\left[x_{1,2} = 
% \pm \dfrac{1}{3}\right]\)
...
\begin{htmulticols}{2}
 ...
 \item~\(- x^{2} + 4 x-7=0\)
  \hfill\(\left[\emptyset\right]\)
%  \item~\(2 x^{2}-\sqrt{5} x-1=0\)
%   \hfill\(\left[x_{1} =-\sqrt{2} \vee x_{2} = 
% \dfrac{3 \sqrt{2}}{2}\right]\)
...
% 15\),\quad 
% c)~\(x_{1} =-\dfrac{2}{3} \vee x_{2} = \dfrac{2}{13}\),\quad 
...
% b)~\(x_{1} 
% =-\dfrac{5}{2} \vee x_{2} =-\dfrac{11}{6}\),\quad 
% c)~\(x_{1} =\dfrac{1}{250} \vee x_{2} =\dfrac{13}{3000}\),\quad 
% d)~\(x_{1} = 1 + \sqrt{3} \vee x_{2} = 1 + \sqrt{5}\)
% 
% \begin{esercizio}[*]
% \label{ese:3.38}
% Risolvi le seguenti equazioni con opportune sostituzioni.
...
% \end{esercizio}
% 
% \paragraph{3.38.} a)~\(x_{1} =0 \vee x_{2} =\dfrac{2}{3}\),\quad 
% b)~\(x_{1} = 5 \vee x_{2} = \dfrac{7}{2}\),\quad 
% c)~\(x_{1} =\dfrac{1}{2} \vee x_{2} =\dfrac{9}{2}\),\quad 
% d)~\(x{1,2}= \pm \sqrt{2}\),\quad 
% e)~\(x_{1} = \dfrac{24}{17} \vee x_{2} = 
% \dfrac{70}{51}\)
...
% c)~\(x_{1} = 0 \vee x_{2} =-\dfrac{5}{4}\),\quad 
% d)~\(x_{1} = 0 \vee x_{2} = \dfrac{7}{4}\),\quad 
% e)~\(x_{1} =-\dfrac{1}{3} \vee x_{2} = 3\)
...
% \fbox{B} \;~\(x_{1} =-2 b-1 \vee x_{2} = 1\)
% \fbox{C} \;~\(x_{1} = x_{2} = 1\)
% \fbox{D} \;~\(x_{1} = 1-2 b \vee x_{2} = 1\)
% \end{esercizio}
% 
% \begin{esercizio}
%  \label{ese:3.66}
...
\fbox{A}\;~ ha come soluzioni\(x_{1} = 0 \vee x_{2} = 1-t\)\quad\fbox{B}\;~ 
ammette 
...
% \hfill\(\left[\forall (x,y)\in \R \times \R:\,y=-2x+3\right]\) 
% ????????
...
\hfill\(\left[\forall k\in \R:~(2;~ 0)\vee (2k-1;~ 2k^2-3k)\right]\)
