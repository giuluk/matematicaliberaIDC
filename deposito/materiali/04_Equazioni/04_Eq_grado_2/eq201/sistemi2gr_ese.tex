...
% 3;1\right)\vee(1;3)\vee(-5;-5)\vee\left(-5;-\frac 5 2\right)\vee\left(3;
% \frac 3 2\right)\vee(-5;-15)\vee(3;9)\),\quad 
% b)~\((0;0)_\text{doppia}\vee\left(\frac 3 4;\frac 3 4\right)
% \vee(1;0) \vee \left (\frac 8{11,} \frac 
% 9{11}\right)\vee\left(\frac{17}{18};\frac 1 6\right)\vee\left(\frac 4 3;
% \frac 2 3\right)\vee\protect\\
% (-4;2)(2;-1)\vee\left(\frac 2 3;\frac 1 3\right)\vee\left(\frac 4{11};
% -\frac 2{11}\right)\vee(4;2)\)
